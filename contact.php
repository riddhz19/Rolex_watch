...
<style>
    * {
    ...
    .btn::before {
        ...
        background: linear-gradient(#081b29, rgb(1, 101, 129), #081b29, rgb(2, 83, 134));
        z-index: -1;
    }
            ...
            <div class="container-fluid">
                <div class="contact-form">
                    <div class="col-md-7 order-md-1">
                        ...
                        You agree that Rolex Watch Limited (‘us’, ‘our’, ‘we’),  Such communications may include requests to participate in customer experience feedback sessions.
